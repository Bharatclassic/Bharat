<%@ Page Title="" Language="C#" MasterPageFile="~/Pharmacy.master" AutoEventWireup="true" CodeFile="Packsize.aspx.cs" Inherits="Packsize" %>
...
<link href="Styles/jquery-ui1.css" rel="Stylesheet" type="text/css" />
   ...
   <script type="text/javascript">
       $(function () {
           $("[id$=txtpackname]").autocomplete({
               source: function (request, response) {
                   $.ajax({
                       url: '<%=ResolveUrl("~/Packsize.aspx/GetCustomers") %>',
    ...
    <h3>
     <asp:Label ID="lblerror" runat="server" Text="" CssClass="ErrorLabel"></asp:Label>
           ...
           <table id="Table1" align="center" runat="server"   cellspacing="5">
                      <tr>
                          <td align="right">
                              <asp:Label ID="lblpackname" runat="server" Text="Pack Name:"  CssClass="Label"></asp:Label>
                         </td>
                           <td align="left">
                               <asp:TextBox ID="txtpackname" width="253px" runat="server" onkeyup="return toUpper(this.id)" onkeypress="return alpha(event)" TabIndex="1" CssClass="TextBox"></asp:TextBox>
           ...
           <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
            <asp:GridView ID="Gridpacksize" runat="server"  Width="629px" CellPadding="4" BackColor="Yellow"
             AllowPaging="true"  Font-Bold="true" ForeColor="Black" Font-Names="Times New Roman" Font-Size="Small"
                      GridLines="Both" OnPageIndexChanging="Gridpacksize_PageIndexChanging" PageSize="5">
