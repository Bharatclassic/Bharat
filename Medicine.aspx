<%@ Page Title="" Language="C#" MasterPageFile="~/Pharmacy.master" AutoEventWireup="true" CodeFile="Medicine.aspx.cs" Inherits="Medicine" %>
...
<link href="Styles/jquery-ui1.css" rel="Stylesheet" type="text/css" />
     ...
     <script type="text/javascript">
         $(function () {
             $("[id$=txtfamily]").autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: '<%=ResolveUrl("~/Medicine.aspx/GetCustomers") %>',
     ...
     Medicine Family
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="lblmod" runat="server" Text="lblsuccemod" Font-Bold="true" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
            </tr>
               <tr>
                   <td>
    ...
    <h3>
         <asp:Label ID="lblerror" runat="server" Text="" CssClass="ErrorLabel"></asp:Label>
           ...
           <table id="Table1" align="center" runat="server" cellspacing="5">
                      <tr>
                    <td align="right">
                        <asp:Label ID="lblfamily" runat="server" Text="Family Type:" CssClass="Label"></asp:Label>
                        </td>
                           <td align="left">
                               <asp:TextBox ID="txtfamily" width="253px" runat="server" onkeyup="return toUpper(this.id)" onkeypress="return alpha(event)" TabIndex="1" CssClass="TextBox"></asp:TextBox>
           ...
           <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
            <asp:GridView ID="Gridmedicine" runat="server"  Width="629px" CellPadding="4" BackColor="Yellow"
             AllowPaging="true"  Font-Bold="true" ForeColor="Black" Font-Names="Times New Roman" Font-Size="Small"
                      GridLines="Both" OnPageIndexChanging="Gridmedicine_PageIndexChanging" PageSize="5">
