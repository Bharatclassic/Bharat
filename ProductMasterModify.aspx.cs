...
public partial class ProductMasterModify : System.Web.UI.Page
{
    ...
    public void shelfrow()
    {
        ...
        for (int i = 0; i <= 20; i++)
        {
            ddlrow.Items.Add(new ListItem(i.ToString(),i.ToString()));
        }
    ...
    public void shelfrowcount()
    {
        ...
        for (int i = 0; i <= 20; i++)
        {
            ddrow.Items.Add(new ListItem(i.ToString(), i.ToString()));
        }
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string Pharmflag10 = "Y";

            DataSet dsgroup10 = clsgd.GetcondDataSet("*", "tblProductMaster", "Pharmflag", Pharmflag10);
            ...
            //}
                ...
                if (!File.Exists(filename))
                {
                    ...
                    if (flag2 == "Y")
                    {
                        ...
                        DataSet dsgroup20 = clsgd.GetcondDataSet("*", "tblGeneric", "GN_name", ddGecode.SelectedItem.Text);
                        if (dsgroup20.Tables[0].Rows.Count > 0)
                        {
                        int gncode = Convert.ToInt32(dsgroup20.Tables[0].Rows[0]["GN_code"].ToString());
                        ...
                        DataSet dsgroup3 = clsgd.GetcondDataSet("*", "tblChemical", "CC_name", ddchem.SelectedItem.Text);
                        if (dsgroup3.Tables[0].Rows.Count > 0)
                        {
                        int cemcode = Convert.ToInt32(dsgroup3.Tables[0].Rows[0]["CC_code"].ToString());
                        ...
                        DataSet dsgroup4 = clsgd.GetcondDataSet("*", "tblMedicine", "FA_name", ddmed.SelectedItem.Text);
                        if (dsgroup4.Tables[0].Rows.Count > 0)
                        {
                        int medcode = Convert.ToInt32(dsgroup4.Tables[0].Rows[0]["FA_code"].ToString());
                        ...
                        DataSet dsgroup5 = clsgd.GetcondDataSet("*", "tblunitmaster", "unitname", ddunit.SelectedItem.Text);
                        if (dsgroup5.Tables[0].Rows.Count > 0)
                        {
                        int Unitcode = Convert.ToInt32(dsgroup5.Tables[0].Rows[0]["unitcode"].ToString());
                        ...
                        DataSet dsgroup6 = clsgd.GetcondDataSet("*", "tblformmaster", "formname", ddform.SelectedItem.Text);
                        if (dsgroup6.Tables[0].Rows.Count > 0)
                        {
                        int formcode = Convert.ToInt32(dsgroup6.Tables[0].Rows[0]["formcode"].ToString());
                        ...
                        DataSet dsgroup7 = clsgd.GetcondDataSet("*", "tblmanufacture", "ManufactureName", ddmanu.SelectedItem.Text);
                        if (dsgroup7.Tables[0].Rows.Count > 0)
                        {
                        int manucode = Convert.ToInt32(dsgroup7.Tables[0].Rows[0]["ManufactureCode"].ToString());
                        ...
                        DataSet dsgroup8 = clsgd.GetcondDataSet("*", "tblPacksize", "Pack_name", ddpack.SelectedItem.Text);
                        if (dsgroup8.Tables[0].Rows.Count > 0)
                        {
                        ...
                        DataSet dsgroup9 = clsgd.GetcondDataSet("*", "tblShelf", "Se_name", ddlshelf.SelectedItem.Text);
                        if (dsgroup9.Tables[0].Rows.Count > 0)
                        {
                        int Shelf_code = Convert.ToInt32(dsgroup9.Tables[0].Rows[0]["se_code"].ToString());
                        ...
                        DataSet dsgroup12 = clsgd.GetcondDataSet("*", "tblShelf", "Se_name", ddshelf.SelectedItem.Text);
                        if (dsgroup12.Tables[0].Rows.Count > 0)
                        {
                        ...
                        if (lblunitcode.Text == "")
                        {
                            Unit = lblunitcode1.Text;

                        }
                        else
                        {
                             Unit = lblunitcode.Text;
                        }
                        ...
                        {
                            Packsize= lblPackcode.Text;
                        }
                        if (lblShelfcode.Text == "")
                        {
                            Shelf = lblShelf1code.Text;

                        }
                        else
                        {
                            Shelf = lblShelfcode.Text;
                        }
                        if (lblShelfcount.Text == "")
                        {
                        ...
                        {
                             Reorderlevel = txtrecordlevel.Text;
                        }
                        ...
                        if (dsd.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (reader.HasRows)
                            {
                                ...
                                ClsBLGP.UpdateProduct("UPDATE_PRODUCTMASTER", prodcode, prodname, lblgrcode.Text, "Y", genericcode, Cemcode, Medcode, Unit, Form, Manufacturer, Packsize, Shelf, Row, Reorderlevel);
                            }
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        if (dsd.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (reader.HasRows)
                            {
                                ...
                                ClsBLGP.UpdateProduct("UPDATE_PRODUCTMASTER", prodcode, prodname, groupname, Pharmflag, "0", "0", "0", unit1, "0", "0", "0", Shelf1, row1, Reorderlevel1);
                        ...
                        {
                            byte[] na = { 00 };
                            ClsBLGP.UpdateProduct("INSERT_PRODUCTMASTER", prodcode, prodname, groupname, Pharmflag, "0", "0", "0", unit1, "0", "0", "0", Shelf1, row1, Reorderlevel1);
                        }
                    }
            ...
            try
            {
                ...
                if (txtProd.Text != "" || txtPname.Text != "")
                {
                    ...
                    using (SqlConnection conn10 = new SqlConnection(strconn11))
                    {
                        ...
                        string pname10 = txtPname.Text;
                        DataSet dscus = clsgd.GetcondDataSet("*", "tblProductMaster", "Productcode", productcode);
                        if (dscus.Tables[0].Rows.Count > 0)
                        {
                            chkgroup.Checked = true;
                            txtPname.Text = dscus.Tables[0].Rows[0]["Productname"].ToString();
                            string gcode25 = dscus.Tables[0].Rows[0]["g_code"].ToString();
                            string gncode10 = dscus.Tables[0].Rows[0]["Genericcode"].ToString();

                            DataSet dscus10 = clsgd.GetcondDataSet("*", "tblGroup", "g_code", gcode25);

                            ddgrpcode.SelectedItem.Text = dscus10.Tables[0].Rows[0]["g_name"].ToString();

                            if (gncode10 != "0")
                            {
                                Panel2.Visible = true;
                                string mgcode = dscus.Tables[0].Rows[0]["Genericcode"].ToString();

                                DataSet dscus11 = clsgd.GetcondDataSet("*", "tblGeneric", "GN_code", mgcode);
                                if (dscus11.Tables[0].Rows.Count > 0)
                                {
                                    ddGecode.SelectedItem.Text = dscus11.Tables[0].Rows[0]["GN_name"].ToString();

                                }


                                string cemcode = dscus.Tables[0].Rows[0]["Cemcode"].ToString();

                                DataSet dscus12 = clsgd.GetcondDataSet("*", "tblChemical", "CC_code", cemcode);

                                if (dscus12.Tables[0].Rows.Count > 0)
                                {
                                    ddchem.SelectedItem.Text = dscus12.Tables[0].Rows[0]["CC_name"].ToString();

                                }


                                string medcode = dscus.Tables[0].Rows[0]["Medcode"].ToString();

                                DataSet dscus13 = clsgd.GetcondDataSet("*", "tblMedicine", "FA_code", medcode);

                                if (dscus13.Tables[0].Rows.Count > 0)
                                {
                                    ddmed.SelectedItem.Text = dscus13.Tables[0].Rows[0]["FA_name"].ToString();
                                ...
                                string unitcode = dscus.Tables[0].Rows[0]["Unit"].ToString();

                                DataSet dscus14 = clsgd.GetcondDataSet("*", "tblunitmaster", "unitcode", unitcode);

                                if (dscus14.Tables[0].Rows.Count > 0)
                                {
                                    ddunit.SelectedItem.Text = dscus14.Tables[0].Rows[0]["unitname"].ToString();

                                }


                                string fcode = dscus.Tables[0].Rows[0]["Form"].ToString();

                                DataSet dscus15 = clsgd.GetcondDataSet("*", "tblformmaster", "formcode", fcode);

                                if (dscus15.Tables[0].Rows.Count > 0)
                                {
                                    ddform.SelectedItem.Text = dscus15.Tables[0].Rows[0]["formname"].ToString();

                                }


                                string mncode = dscus.Tables[0].Rows[0]["Manufacturer"].ToString();

                                DataSet dscus16 = clsgd.GetcondDataSet("*", "tblmanufacture", "ManufactureCode", mncode);

                                if (dscus16.Tables[0].Rows.Count > 0)
                                {
                                    ddmanu.SelectedItem.Text = dscus16.Tables[0].Rows[0]["ManufactureName"].ToString();

                                }



                                string pkcode = dscus.Tables[0].Rows[0]["Packsize"].ToString();

                                DataSet dscus17 = clsgd.GetcondDataSet("*", "tblPacksize", "Pack_code", pkcode);

                                if (dscus17.Tables[0].Rows.Count > 0)
                                {
                                    ddpack.SelectedItem.Text = dscus17.Tables[0].Rows[0]["Pack_name"].ToString();

                                }



                                string shelfcode = dscus.Tables[0].Rows[0]["Shelf"].ToString();

                                DataSet dscus18 = clsgd.GetcondDataSet("*", "tblShelf", "Se_code", shelfcode);

                                if (dscus18.Tables[0].Rows.Count > 0)
                                {
                                    ddlshelf.SelectedItem.Text = dscus18.Tables[0].Rows[0]["Se_name"].ToString();

                                }


                                txtrecordlevel.Text = dscus.Tables[0].Rows[0]["Reorderlevel"].ToString();
                            ...
                            else
                            {
                                ...
                                if (dscus18.Tables[0].Rows.Count > 0)
                                {
                                    ddshelf.SelectedItem.Text = dscus18.Tables[0].Rows[0]["Se_name"].ToString();
                                ...
                                if (dscus14.Tables[0].Rows.Count > 0)
                                {
                                    ddlunit.SelectedItem.Text = dscus14.Tables[0].Rows[0]["unitname"].ToString();

                                }


                                txtreorder.Text = dscus.Tables[0].Rows[0]["Reorderlevel"].ToString();
                            }
    ...
    protected void txtPname_TextChanged(object sender, EventArgs e)
    {
        ...
        if (txtProd.Text != "" || txtPname.Text != "")
        {
            ...
            using (SqlConnection conn10 = new SqlConnection(strconn11))
            {
                ...
                string pname10 = txtPname.Text;
                DataSet dscus = clsgd.GetcondDataSet("*", "tblProductMaster", "Productname", pname10);
                if (dscus.Tables[0].Rows.Count > 0)
                {
                    txtProd.Text = dscus.Tables[0].Rows[0]["Productcode"].ToString();
                  
                    string gcode25 = dscus.Tables[0].Rows[0]["g_code"].ToString();
                    string gncode10 = dscus.Tables[0].Rows[0]["Genericcode"].ToString();

                    DataSet dscus10 = clsgd.GetcondDataSet("*", "tblGroup", "g_code", gcode25);
                    string check = dscus.Tables[0].Rows[0]["Row"].ToString();
                    ddlrow.SelectedItem.Text = check;
                    ddgrpcode.SelectedItem.Text = dscus10.Tables[0].Rows[0]["g_name"].ToString();
                    ...
                    if (gncode10 != "0")
                    {
                      ...
                      string mgcode   = dscus.Tables[0].Rows[0]["Genericcode"].ToString(); 
                        ...
                        if (dscus14.Tables[0].Rows.Count > 0)
                        {
                          ...
                          {
                              ddlshelf.SelectedItem.Text = dscus18.Tables[0].Rows[0]["Se_name"].ToString();
                             // ddlrow.SelectedItem.Text = dscus18.Tables[0].Rows[0]["srcount"].ToString();
                          }
                    ...
                    else
                    {
                       ...
                       string check10 = dscus.Tables[0].Rows[0]["Row"].ToString();
                       ddrow.SelectedItem.Text = check;
